...
export const useForm = (initialState, submitCallback) => {
    ...
    const asesorias = ['Tipo de Asesoria', 'Mejoravit', 'Laudo', 'Linea 2', 'Pensión', 'Modalidad 40'];
    ...
    const validateAsesoria = (newErrors) => {
        if (!formData.asesoria.trim() || formData.asesoria === 'Tipo de Asesoria') {
            newErrors.asesoria = 'Selecciona un tipo de Asesoria válido.';
        }
    };
    ...
    return { formData, errors, loading, handleChange, handleSubmit, asesorias, showAlert };
};
